...
public class SampleTankDriveMR extends SampleTankDriveBase {
    ...
    public SampleTankDriveMR(HardwareMap hardwareMap) {
        ...
        DcMotor leftFront = hardwareMap.dcMotor.get("motorFL");
        DcMotor leftRear = hardwareMap.dcMotor.get("motorBL");
        DcMotor rightRear = hardwareMap.dcMotor.get("motorBR");
        DcMotor rightFront = hardwareMap.dcMotor.get("motorFR");
