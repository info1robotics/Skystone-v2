...
import static roadrunner.drive.DriveConstants.getMotorVelocityF;
...
public class SampleTankDriveREVOptimized extends SampleTankDriveBase {
    ...
    public SampleTankDriveREVOptimized(HardwareMap hardwareMap) {
        ...
        ExpansionHubMotor leftFront = hardwareMap.get(ExpansionHubMotor.class, "motorFL");
        ExpansionHubMotor leftRear = hardwareMap.get(ExpansionHubMotor.class, "motorBL");
        ExpansionHubMotor rightRear = hardwareMap.get(ExpansionHubMotor.class, "motorBR");
        ExpansionHubMotor rightFront = hardwareMap.get(ExpansionHubMotor.class, "motorFR");
