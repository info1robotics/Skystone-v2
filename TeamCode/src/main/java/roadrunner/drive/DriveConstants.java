...
import roadrunner.drive.custom_motors.CustomGoBilda269;
...
public class DriveConstants {
    ...
    private static final MotorConfigurationType MOTOR_CONFIG =
            MotorConfigurationType.getMotorType(CustomGoBilda269.class);
    ...
    public static final PIDCoefficients MOTOR_VELO_PID = new PIDCoefficients(2, 0, 0.5);
    ...
    public static double TRACK_WIDTH = 17.13;
